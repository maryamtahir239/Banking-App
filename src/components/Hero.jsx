...
const Hero = () => (
  ...
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart}
      ...
      <div className='flex flex-row ittems-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
       ...
       <div className='absolute z-[1] w-[80%] h-[85%] rounded-full botton-40 white__gradient' />
